...
>>>>>>> a7a0a19fb86c59516669f3d9fb73c89e1a23afd5:laravel-module/public/app/main-es5.js
...
=======
module.exports = "\n    .dark-modal .modal-content {\n        background-color: #292b2c;\n        color: white;\n      }\n      .dark-modal .close {\n        color: white;\n      }\n      .light-blue-backdrop {\n        background-color: #5cb3fd;\n      }\n      label,input, button{\n        font-size: 12px;\n      }\n      tr,th{\n        font-size: 12px;\n      }\n      th{\n        color: white;\n        background: #138D75;\n      }\n      #demoFont {\n        text-shadow: -1px -1px 1px rgba(255,255,255,.1), 1px 1px 1px rgba(0,0,0,.5), 2px 2px 2px rgba(206,89,55,0);\n        color: #d9d9d9;\n        background: #4B94AD;\n        }\n      .ColorThCS{\n    background: #1ABC66;\n  }\n\n/*# sourceMappingURL=data:application/json;base64, */"
>>>>>>> a7a0a19fb86c59516669f3d9fb73c89e1a23afd5:laravel-module/public/app/main-es5.js
...
var TablaSindicalComponent = /** @class */ (function () {
    function TablaSindicalComponent(config, modalService) {
        this.modalService = modalService;
        this.selectAnio = [];
        this.selectMes = [];
        config.backdrop = 'static';
...
var ModalCajaChicaComponent = /** @class */ (function () {
    function ModalCajaChicaComponent(config, modalService, _cajaChicaService) {
        this.modalService = modalService;
...
var ModalInicioMesComponent = /** @class */ (function () {
    //-------------------------
    function ModalInicioMesComponent(config, modalService, _http) {
        this.modalService = modalService;
        this._http = _http;
    ...
    ModalInicioMesComponent.prototype.calcular_cierre_mensual = function (anio, mes) {
        var _this = this;
        this._http.get(this.url + "calcular_cm/" + this.anio + "/" + this.mes, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'Authorization': 'Bearer' + this.token }) }).subscribe(function (val) {
            _this.monto = val;
            console.log(val);
    ...
    ModalInicioMesComponent.prototype.anio_actual = function () {
        var _this = this;
        this._http.get(this.url + "anio_actual", { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'Authorization': 'Bearer' + this.token }) }).subscribe(function (val) {
            _this.anio = val.id;
            _this.listar_tabla();
        }, function (response) { console.log("POST call in error", response); }, function () {
            console.log("The POST success.");
    ...
    ModalInicioMesComponent.prototype.mes_actual = function () {
        var _this = this;
        this._http.get(this.url + "mes_actual", { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'Authorization': 'Bearer' + this.token }) }).subscribe(function (val) {
            _this.mes = val.id;
        }, function (response) { console.log("POST call in error", response); }, function () {
            console.log("The POST success.");
        });
    ...
    ModalInicioMesComponent.prototype.guardar = function () {
        ...
        this._http.post(this.url + "guardar_inicio_mensual", formData, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'Authorization': 'Bearer' + this.token }) }).subscribe(function (val) {
            _this.listar_tabla();
    ...
    ModalInicioMesComponent.prototype.listar_tabla = function () {
        var _this = this;
        this._http.get(this.url + "listar_inicio_y_cierre_mensual_cs/" + this.anio, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'Authorization': 'Bearer' + this.token }) }).subscribe(function (val) {
            _this.tabla = val;
        }, function (response) { console.log("POST call in error", response); }, function () {
            console.log("The POST success.");
        });
    ...
    ModalInicioMesComponent.prototype.usuario_logeado = function () {
        var _this = this;
        this._http.get(this.url + "usuario_logeado", { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'Authorization': 'Bearer' + this.token }) }).subscribe(function (val) {
            _this.user = val;
        }, function (response) { console.log("POST call in error", response); }, function () {
            console.log("The POST success.");
        });
    ...
    ModalInicioMesComponent.prototype.btn_validar_usuario = function ($rut, $password, validar) {
        ...
        this._http.post(this.url + "confirmar_usuario", formData, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'Authorization': 'Bearer' + this.token }) }).subscribe(function (val) {
...
var CajaChicaService = /** @class */ (function () {
    ...
    CajaChicaService.prototype.ingresarValor = function (form) {
    ...
    CajaChicaService.prototype.getCajaChica = function (form) {
        console.log(form);
