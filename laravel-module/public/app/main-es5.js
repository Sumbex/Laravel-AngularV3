...
var TablaSindicalComponent = /** @class */ (function () {
    ...
    TablaSindicalComponent.prototype.actualizar = function (id, campo, input) {
        ...
        this._sindicalService.getTablaSindicalActualizar(id, campo, this.entrada).subscribe(function (response) {
            if (response.estado == "success") {
                _this.alertEstado = true;
                _this.alertMensaje = response.mensaje;
                //this.modalActualizar.close();
                _this.alertEstado = false;
                _this.alertMensaje = "";
            }
            if (response.estado == "failed") {
                _this.alertEstado = true;
...
var ListarSociosComponent = /** @class */ (function () {
    ...
    ListarSociosComponent.prototype.actualizar = function (id, campo, valor) {
        var _this = this;
        var form = new FormData();
        form.append('id', id);
        form.append('campo', campo);
        form.append('valor', valor.value);
        this._socios.getEditar(form).subscribe(function (response) {
            if (response.estado == "success") {
...
var ModalPrestamosSociosComponent = /** @class */ (function () {
    function ModalPrestamosSociosComponent(config, modalService, _sindicalService, _sociosService) {
        ...
        this.inputMontoPrestamo = null;
        this.radioAbono = "false";
    ...
    ModalPrestamosSociosComponent.prototype.consultarSocio = function (rut) {
        ...
        this._sociosService.getSocio(rut).subscribe(function (res) {
            if (res.estado == 'failed') {
                ...
                _this.mensajeError = res.mensaje;
                ...
                console.log(_this.nombreSocioTest);
                console.log(_this.rutSocioTest);
            }
        }, function (error) {
            console.log(error);
        });
    ...
    ModalPrestamosSociosComponent.prototype.onSubmit = function (res) {
        console.log(res);
    };
