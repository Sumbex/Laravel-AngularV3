...
/* harmony import */ var src_app_servicios_sindical_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/servicios/sindical.service */ "./src/app/servicios/sindical.service.ts");
...
let FormularioSindicalComponent = class FormularioSindicalComponent {
    constructor(config, modalService, _aniosService, _tiposService, _sindicalService) {
...
let ModalCajaChicaComponent = class ModalCajaChicaComponent {
    constructor(config, modalService, _aniosService, _tiposService) {
        this.modalService = modalService;
        this._aniosService = _aniosService;
        this._tiposService = _tiposService;
        this.selectAnio = [];
