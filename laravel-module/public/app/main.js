...
let TablaSindicalComponent = class TablaSindicalComponent {
    constructor(config, modalService, _sindicalService) {
        this.modalService = modalService;
        this._sindicalService = _sindicalService;
        this.selectAnio = [];
        this.selectMes = [];
    ...
    refrescarSindical() {
        this._sindicalService.getTablaSindical('1', '1').subscribe(response => {
