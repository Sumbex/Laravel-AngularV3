...
var TablaSindicalComponent = /** @class */ (function () {
    function TablaSindicalComponent(config, modalService, _sindicalService, _fechasService, _validarusuario) {
        this.modalService = modalService;
        this._sindicalService = _sindicalService;
    ...
    TablaSindicalComponent.prototype.btn_validar_usuario = function ($rut, $password, validar) {
        var _this = this;
        this.load = true;
        var formData = new FormData();
        formData.append('rut', $rut.value);
        ...
        this._validarusuario.validar_usuario(formData).subscribe(function (val) {
            if (val > 0) { //si tiene acceso;
                ...
                _this.validarModalActualizar.close();
            }
            else {
                alert("Acceso denegado");
                _this.load = false;
    ...
    TablaSindicalComponent.prototype.validar_usuario = function (modalUsuario) {
...
var TablaPrestamosSociosComponent = /** @class */ (function () {
    function TablaPrestamosSociosComponent() {
    }
